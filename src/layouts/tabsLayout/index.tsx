...
const TabsLayout = (props: Props) => {
    ...
    return (
        <div className={""}>
            ...
            <div className={"min-h-[calc(100vh-20rem)] w-full"}>
                {props.children}
            </div>
            <div
                className={
            ...
            >
              ...
              `}
                        ...
                        >
                            <Link href={item.link}
                                  className={`${(currentTab === item.link) ? " w-10 bg-green-200 " : "w-0"} px-4 py-1 ease-out transition-all duration-300 rounded-full flex flex-row items-center justify-center`}>
