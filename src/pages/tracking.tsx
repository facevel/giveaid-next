    ...
    return (
        <>
            <div className={"container mx-auto flex flex-col justify-center items-center"}>
                                    ...
                                    <div className="mb-6">
                                        ...
                                        <div className={"flex space-x-6 text-gray-500 justify-center items-center"}>
                                            <input type="number" id="email"
                                                   className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-green-500 dark:focus:border-green-500 placeholder-gray-400"
                ...
                <div className={"pt-12 mx-6 mb-20"}>
                    {loading && (
